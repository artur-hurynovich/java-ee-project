...
<html>
	...
	<body>
		...
		<div class = "wrapper">
			<div class = "left">
				<p><b><fmt:message key = "reviews.total" /> ${reviewsNumber}</b>
				<form action = "controller" method = "post">
					<div class = "form-inline" style = "margin-bottom: 10px">
						<div>
							<input type = "text" name = "hashtags" placeholder = "<fmt:message 
							key = "reviews.by_hashtags" />">
						</div>
								...
								<c:choose>
									<c:when test = "${page == pageNumber}">
										<li class = "page-item" >
											...
											href = "controller?command=reviews_page&page_number=${page}">${page}</a>
										</li>
									</c:when>
									<c:otherwise>
										<li class = "page-item" >
