...
public class InstrumentsNewSubgroupSuccessPageCommand implements ICommand {
	private final ResourceBundle pathsundle = BundleFactory.getInstance().getPathsBundle();
	private final String page = pathsundle.getString("instruments.new_subgroup_success");
