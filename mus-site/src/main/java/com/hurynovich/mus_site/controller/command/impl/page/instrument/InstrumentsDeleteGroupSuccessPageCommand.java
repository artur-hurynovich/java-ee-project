...
public class InstrumentsDeleteGroupSuccessPageCommand implements ICommand {
	private final ResourceBundle pathsundle = BundleFactory.getInstance().getPathsBundle();
	private final String page = pathsundle.getString("instruments.delete_group_success");
