...
public class InstrumentsDeleteCommand implements ICommand {
	...
	public String execute(HttpServletRequest request) throws InstrumentDAOException {
		...
		if (instrumentService.deleteInstrument(instrumentId)) {
